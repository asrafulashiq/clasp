...
parser = argparse.ArgumentParser(
    description='Finetune parameters for SiamMask tracker on DAVIS')
...
def main():
    ...
    p['network'] = model
    p['network_name'] = args.arch + '_mask_' + args.resume.split(
        '/')[-1].split('.')[0]
